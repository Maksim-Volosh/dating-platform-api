...
async def test_upload_user_photo_success(
    ...
    photo_repo.get_by_user_id.assert_awaited_once_with(1)
    photo_repo.create.assert_awaited_once_with(1, [fake_photo_entity, fake_photo_entity])
...
async def test_upload_user_photo_too_many_photos_exists(
    ...
    photo_repo = AsyncMock()
    photo_repo.get_by_user_id.return_value = [fake_photo_entity, fake_photo_entity, fake_photo_entity]
